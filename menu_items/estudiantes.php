...
<div class="body2">
    <form action="../php_others/api.php" method="POST" id="form" data-metodo="login">
      <h2>Ingreso exclusivo<br>estudiantes<br><br><br> </h2>
      <img src="../img/usuario.png" id="usuario_login_img">
      <div class="form">
          <h1>Inicio de sesión</h1>
          <div class="grupo">
              <input type="text" name="user" id="name" required value="davidvidal@gmail.com"><span class="barra"></span>
              <label for="">Nombre o Usuario</label>
          </div>
          
          <div class="grupo"> 
              <input type="password" name="password" id="password" required value="12345678"><span class="barra"></span>
