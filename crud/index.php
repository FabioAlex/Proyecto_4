...
<header>
        ...
        <p class="header__type">Estudiante</p>
    ...
    <div class="options__menu">
        ...
        <a href="archives_php/talleres.php">
            <div class="option">
        ...
        <a href="archives_php/informes.php">
            <div class="option">
